...
from combat_functions import max_items, combat
from other_functions import door_code, final_door_fight, game_credits
...
def start_story(player, enemies, start_at=0):
    ...
    if start_at == 2.1:
        ...
        return play_again
    if start_at == 2.2:
        play_again = chapter2_path2(player)
        return play_again
...
def chapter1(player, enemies):
    ...
    if camp_choice == "Camp":
        ...
        message = combat(enemies, forest_beast, player, player.inventory, 1)
        if message == "you died":
        ...
        message = combat(enemies, shadow_creature, player, player.inventory, 1)
        if message == "you died":
            play_again = inquirer_input(slow_text("Do you want to play again", 0.04), ["Yes", "No"])
            return play_again
...
def chapter2_path1(player, enemies):
    ...
    if temple_path_choice == "Front":
        ...
        shadow_creature = Charachter(125, 30, 50, 10, 20, 30, "Shadow Creature")
        message = combat(enemies, shadow_creature, player, player.inventory, 2)
        if message == "you died":
            play_again = inquirer_input(slow_text("Do you want to play again", 0.04), ["Yes", "No"])
            return play_again
        ...
        # If you choose 1
        if door_choice == "1":
            door_code(door_choice, 1, shadow_creature, player, enemies, player.inventory)
            door_choice = inquirer_input(slow_text("There are two doors in front of you", 0.04), ["1", "2"])
            # If you choose 1, 1
            if door_choice == "1":
                door_code(door_choice, 2, shadow_creature, player, enemies, player.inventory)
                door_choice = inquirer_input(slow_text("There are two doors in front of you", 0.04), ["1", "2"])
                # If you choose 1, 1, 1
                if door_choice == "1":
                    door_code(door_choice, 3, shadow_creature, player, enemies, player.inventory)
    ...
    #Back route
        ...
        if "Godslayer" in player.inventory:
            player.inventory.remove("Godslayer")
        the_forest_shadow = Charachter(150, 50, 70, 10, 30, 40, "The Final Boss: The Forest Shadow")
        message = combat(enemies, the_forest_shadow, player, player.inventory, 1)
        if message == "you died":
            play_again = inquirer_input(slow_text("Do you want to play again", 0.04), ["Yes", "No"])
            return play_again
...
def chapter2_path2(player, enemies):
    ...
    if trust_choice == "Yes":
        ...
        message = combat(enemies, shadow_creature_hard, player, player.inventory, 1)
        if message == "you died":
            play_again = inquirer_input(slow_text("Do you want to play again", 0.04), ["Yes", "No"])
            return play_again
        ...
        message = combat(enemies, shadow_creature_hard, player, player.inventory, 2)
        if message == "you died":
            play_again = inquirer_input(slow_text("Do you want to play again", 0.04), ["Yes", "No"])
            return play_again
        ...
        message = combat(enemies, the_forest_shadow_hard, player, player.inventory, 1)
        if message == "you died":
            play_again = inquirer_input(slow_text("Do you want to play again", 0.04), ["Yes", "No"])
            return play_again
        ...
        message = combat(enemies, shadow_creature, player, player.inventory, 3)
        if message == "you died":
            play_again = inquirer_input(slow_text("Do you want to play again", 0.04), ["Yes", "No"])
            return play_again
        if "Godslayer" in player.inventory:
        ...
        message = combat(enemies, true_final_boss, player, player.inventory, 1)
        if message == "you died":
            play_again = inquirer_input(slow_text("Do you want to play again", 0.04), ["Yes", "No"])
            return play_again
        ...
        dead_or_not = combat(enemies, true_final_boss_revived, player, player.inventory, 1)
        # Evil ending
